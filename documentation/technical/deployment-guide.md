...
# Opcjonalne: zależności development
...
### 5. Pobieranie PlantUML

```bash
# Automatyczne pobieranie PlantUML
python -c "
...
steps:
  ...
  - name: 'gcr.io/cloud-builders/gcloud'
    ...
    - 'managed'
    - '--set-env-vars'
    - 'MODEL_PROVIDER=gemini,LANGUAGE=pl'
    - '--set-secrets'
