...
prompt_templates = {
            ...
            "Diagram aktywności": {
                "template": (
                    ...
                    "4. **Logiczna sekwencja aktywności**\n"
                    "5. **Zakończ:** `@enduml`\n\n"
            ...
            "BPMN - podstawowy": {
                "template": (
                    "**Jako doświadczony analityk biznesowy i architekt procesów z 10-letnim stażem w notacji BPMN 2.0, przygotuj kompletny diagram procesu biznesowego zgodnie z opisem:**\n\n"
                    "{process_description}\n\n"
                    "**ANALIZA PROCESU:**\n"
                    "1. Zidentyfikuj wszystkich uczestników procesu\n"
                    "2. Określ sekwencję kroków i punkty decyzyjne\n"
                    "3. Wyłap interakcje między uczestnikami\n"
                    "4. Uwzględnij scenariusze wyjątkowe i błędy\n\n"
                    "**WYMAGANIA TECHNICZNE:**\n"
                    "- Format: Kompletny, walny kod XML BPMN 2.0\n"
                    "- Kompatybilność: Gotowy do bezpośredniego importu w Camunda Modeler 5.x\n"
                    "- Struktura: Wszystkie wymagane sekcje XML (definitions, process, collaboration, bpmndi)\n"
                    "- Przestrzenie nazw: Użyj pełnych definicji xmlns dla BPMN 2.0\n\n"
                    "**ARCHITEKTURA DIAGRAMU:**\n"
                    "- **Pools**: Osobne baseny dla każdego głównego uczestnika\n"
                    "- **Lanes**: Podziały wewnątrz pools dla różnych ról/systemów\n"
                    "- **Message Flows**: Komunikacja między uczestnikami\n"
                    "- **Sequence Flows**: Przepływ wewnątrz procesu\n\n"
                    "**TYPY ELEMENTÓW:**\n"
                    "- Start/End Events: Odpowiednie typy (None, Message, Timer, Error)\n"
                    ...
                    "**STANDARDOWI UCZESTNICY (dostosuj do kontekstu):**\n"
                    "1. Klient/Użytkownik (Pool: \"Klient\")\n"
                    "2. Organizacja/Dział (Pool: \"[Nazwa organizacji]\")\n"
                    "3. System zewnętrzny (Pool: \"System [Nazwa]\")\n"
                    "4. Partner/Dostawca (Pool: \"[Nazwa partnera]\")\n\n"
                    "**OBSŁUGA BŁĘDÓW:**\n"
                    "- Error Events dla krytycznych błędów\n"
                    "- Escalation Events dla eskalacji\n"
                    "- Compensation Events gdzie wymagane\n"
                    "- Timeout Events dla limitów czasowych\n\n"
                    "**WYMAGANIA JAKOŚCI:**\n"
                    "- Wszystkie elementy z unikalnymi ID (format: Element_001, Task_002, etc.)\n"
                    "- Nazwy w języku polskim, czytelne i opisowe\n"
                    "- Poprawne atrybuty dla każdego elementu\n"
                    "- Kompletne informacje DI (pozycje, rozmiary, kolory)\n\n"
                    "**SEKCJE XML - WYMAGANE:**\n"
                    "```xml\n"
